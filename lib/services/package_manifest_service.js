...
var PackageManifestService = function () {
  ...
  _createClass(PackageManifestService, null, [{
    ...
    value: function present(manifest) {
      ...
      var processChildren = function processChildren(children, folderNames) {
        var files = [];
        var foldersToProcess = [];
        children = _this2._sort(children);
        children.forEach(function (child) {
          if (child.hasOwnProperty('children')) {
            if (_this2._hasNonFolderChild(child)) {
              numberOfFolders += 1;
      ...
      return { numberOfFiles: numberOfFiles, numberOfFolders: numberOfFolders, sorted: sorted };
    }
