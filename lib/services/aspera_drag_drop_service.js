...
var AsperaDragDropService = function () {
  ...
  _createClass(AsperaDragDropService, null, [{
    ...
    key: '_collectFiles',
    value: function _collectFiles(entries, path, allPromises, collection) {
      var _this2 = this;
              ...
              var readEntries = function readEntries() {
                reader.readEntries(function (childEntries) {
                  if (childEntries.length) {
                    var childReadPromise = _this2._collectFiles(childEntries, entry.fullPath, allPromises, collection);
