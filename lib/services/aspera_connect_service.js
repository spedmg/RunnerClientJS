...
var REQUIRED_ASPERA_VERSION = '3.10.1';
...
var AsperaConnectService = function () {
  ...
  _createClass(AsperaConnectService, null, [{
    ...
    value: function initialize() {
      var id = generateID();
      if (!isBrowser()) {
        throw new Error('AsperaConnectService can only be used in browsers');
      }
    ...
    value: function start(transferSpecs, connectionSettings) {
      ...
      var startTransferForIndex = function startTransferForIndex(index) {
        var result = _this.connect.startTransfer(transferSpecs[index], connectionSettings, {
      ...
      transferSpecs.forEach(function (transferSpec, index) {
        var promise = new Promise(function (resolve, reject) {
          promiseFunctions[index] = { resolve: resolve, reject: reject };
        });
